...
module.exports = {
  ...
  rules: {
    ...
    'no-magic-numbers': ['error', { 'ignore': [0, 1, -1, 100, 1000, 1536, 1024, 384] }], // Allow common vector dimensions
  ...
  overrides: [
    {
      // Vector store files
      files: ['**/embeddings/**/*.js', '**/vector-store/**/*.js', '**/chroma/**/*.js', '**/weaviate/**/*.js'],
      rules: {
        'max-statements': ['error', 30], // Vector operations need more statements
        'no-magic-numbers': ['error', { 'ignore': [0, 1, -1, 50, 100, 512, 768, 1024, 1536, 3072] }] // Common embedding dimensions
      }
    },
    {
